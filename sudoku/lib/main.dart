...
class HomePageState extends State<HomePage> {
  ...
  static Future<List<List<List<int>>>> getNewGame(
      [String difficulty = 'легкий']) async {
    int emptySquares;
    switch (difficulty) {
      case 'test':
        {
  ...
  void setGame(int mode, [String difficulty = 'легкий']) async {
    if (mode == 1) {
  ...
  void newGame([String difficulty = 'легкий']) {
    setState(() {
          ...
          return Wrap(
            children: [
              ListTile(
                ...
                title: Text('Рестарт игры', style: customStyle),
                onTap: () {
              ...
              ListTile(
                ...
                title: Text('Новая игра', style: customStyle),
                onTap: () {
                  Navigator.pop(context);
              ...
              ListTile(
                leading: Icon(Icons.lightbulb_outline_rounded,
                    color: Styles.foregroundColor),
                title: Text('Показать решение', style: customStyle),
                onTap: () {
                  Navigator.pop(context);
                  Timer(
              ...
              ListTile(
                ...
                title: Text('Выбор сложности', style: customStyle),
                onTap: () {
                  Navigator.pop(context);
                  Timer(
              ...
              ListTile(
                leading: Icon(Icons.invert_colors_on_rounded,
                    color: Styles.foregroundColor),
                title: Text('Тема', style: customStyle),
                onTap: () {
                  Navigator.pop(context);
                  Timer(const Duration(milliseconds: 200), () {
                    changeTheme('switch');
              ...
              ListTile(
                leading: Icon(Icons.color_lens_outlined,
                    color: Styles.foregroundColor),
                title: Text('Цвет игры', style: customStyle),
                onTap: () {
                  Navigator.pop(context);
                  Timer(
              ...
              ListTile(
                leading: Icon(Icons.info_outline_rounded,
                    color: Styles.foregroundColor),
                title: Text('Об игре', style: customStyle),
                onTap: () {
                  Navigator.pop(context);
                  Timer(
                      const Duration(milliseconds: 200),
